...
TRANSLATIONS = {
    "en": {
        ...
        "invest_scorecard_tip": "Composite score (0-100) calculated from 10 weighted indicators. Higher = more attractive for investment. Filter by region or income group to refine the analysis.",
    "invest_include_micro": "Include micro-states & offshore jurisdictions (< 1M pop.)",
    "invest_micro_note": "Micro-states (< 1M inhabitants) are excluded by default: their ratios reflect offshore financial flows, not a comparable real economy. Scores use world percentile ranks (median = 50).",
        ...
        "invest_red_flags_tip": "Countries are flagged when they exceed standard risk thresholds: inflation > 15%, debt > 150% GDP, unemployment > 20%, political instability < -1.5 (WGI), corruption perception < 25 (CPI).",
    ...
    "fr": {
        ...
        "invest_scorecard_tip": "Score composite (0-100) calculé à partir de 10 indicateurs pondérés. Plus élevé = plus attractif pour l'investissement. Filtrez par région ou groupe de revenu pour affiner l'analyse.",
    "invest_include_micro": "Inclure les micro-États et juridictions offshore (< 1 M hab.)",
    "invest_micro_note": "Les micro-États (< 1 M d'habitants) sont exclus par défaut : leurs ratios reflètent des flux financiers offshore, pas une économie réelle comparable. Scores en rangs percentils mondiaux (médiane = 50).",
        ...
        "invest_red_flags_tip": "Les pays sont signalés lorsqu'ils dépassent des seuils de risque standards : inflation > 15%, dette > 150% PIB, chômage > 20%, instabilité politique < -1,5 (WGI), perception corruption < 25 (IPC).",
